...
from tllib.utils.analysis import collect_feature0, tsne, a_distance
...
def main(args: argparse.Namespace):
    ...
    if args.phase == 'analysis':
        ...
        source_feature = collect_feature0(train_source_loader, feature_extractor, device)
        target_feature = collect_feature0(train_target_loader, feature_extractor, device)
        # plot t-SNE
    ...
    if args.phase == 'test':
        acc1 = utils.validate_0(test_loader, classifier, args, device)
        print(acc1)
        return
    ...
    for epoch in range(args.epochs):
        ...
        acc1 = utils.validate_0(val_loader, classifier, args, device)
