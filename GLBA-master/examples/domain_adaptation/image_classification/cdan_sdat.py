...
def main(args: argparse.Namespace):
    ...
    # classifier = Conformer(patch_size=16, num_classes=num_classes, channel_ratio=4, embed_dim=384, depth=12,
    #                        num_heads=6, mlp_ratio=4, qkv_bias=True, drop_path_rate=0.1).to(device)
    ...
    for k, v in classifier.named_parameters():
        # if v == classifier.bottleneck.parameters():
        #     param_group += classifier.get_bottleneck_parameters()
        # elif v == classifier.bottleneck_t.parameters():
        #     param_group += classifier.get_bottleneck_t_parameters()
        # elif v == classifier.cls_head.parameters():
        #     param_group += classifier.get_cls_parameters()
        # else:
