...
def main(args: argparse.Namespace):
    ...
    all_parameters = classifier.get_parameters() + domain_discri_1.get_parameters()
    ...
    for epoch in range(args.epochs):
        ...
        # train for one epoch
        train(train_source_iter, train_target_iter, classifier, domain_adv_1, mcc_loss, optimizer,
...
def train(train_source_iter: ForeverDataIterator, train_target_iter: ForeverDataIterator, model: Conformer,
          domain_adv_1, mcc, optimizer: SGD, lr_scheduler, epoch: int, args: argparse.Namespace):
