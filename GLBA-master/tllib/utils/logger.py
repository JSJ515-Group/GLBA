...
class CompleteLogger:
    ...
    def __init__(self, root, phase='train'):
        self.root = root
        self.phase = phase
        self.visualize_directory_c = os.path.join(self.root, "visualize_c")
        self.visualize_directory_t = os.path.join(self.root, "visualize_t")
        self.checkpoint_directory = os.path.join(self.root, "checkpoints")
        self.epoch = 0

        os.makedirs(self.root, exist_ok=True)
        os.makedirs(self.visualize_directory_c, exist_ok=True)
        os.makedirs(self.visualize_directory_t, exist_ok=True)
    ...
    def set_epoch(self, epoch):
        ...
        os.makedirs(os.path.join(self.visualize_directory_c, str(epoch)), exist_ok=True)
        os.makedirs(os.path.join(self.visualize_directory_t, str(epoch)), exist_ok=True)
        self.epoch = epoch
    ...
    def get_image_path(self, filename: str):
        ...
        """
        return os.path.join(self.visualize_directory_c, self._get_phase_or_epoch(), filename)
